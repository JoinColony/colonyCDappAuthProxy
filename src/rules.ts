...
export const rules: RulesConfig = {
  ...
  types: {
    ...
    InitializeUserReturn: true,
    FailedTransaction: true,

    // Return/Result types
    DomainBalanceInOut: true,
    TimeframeDomainBalanceInOut: true,
    DomainBalanceReturn: true,
    CacheAllDomainBalanceReturn: true,
    MarketPrice: true,
    BridgeCheckKYCReturn: true,
    BridgeGatewayFeeReturn: true,
    BridgeDrainReceipt: true,
    BridgeDrain: true,
    BridgeIbanBankAccount: true,
    BridgeUsBankAccount: true,
    BridgeBankAccount: true,
    BridgeCreateBankAccountReturn: true,
    BridgeUpdateBankAccountReturn: true,
    BridgeXYZMutationReturn: true,
    TokenFromEverywhereReturn: true,
    GetUserTokenBalanceReturn: true,
    GetMotionTimeoutPeriodsReturn: true,
    VoterRewardsReturn: true,

    // Nested/Embedded types
    NativeTokenStatus: true,
    ColonyStatus: true,
    ChainMetadata: true,
    ProfileMetadata: true,
    ColonyUnclaimedStake: true,
    ExternalLink: true,
    ColonyObjective: true,
    ColonyMetadataEtherealData: true,
    ColonyMetadataChangelog: true,
    TransactionGroup: true,
    TransactionError: true,
    DomainMetadataChangelog: true,
    ColonyChainFundsClaim: true,
    ColonyBalance: true,
    ColonyBalances: true,
    MotionStakeValues: true,
    MotionStakes: true,
    UserMotionStakes: true,
    StakerRewards: true,
    VoterRecord: true,
    MotionStateHistory: true,
    ExpenditureFundingItem: true,
    VotingReputationParams: true,
    MultiSigDomainConfig: true,
    MultiSigParams: true,
    StakedExpenditureParams: true,
    ExtensionParams: true,
    Payment: true,
    ApprovedTokenChanges: true,
    ExpenditureSlotChanges: true,
    ArbitraryTxAbi: true,
    ColonyActionRoles: true,
    ColonyActionArbitraryTransaction: true,
    ExpenditureSlot: true,
    ExpenditurePayout: true,
    ExpenditureBalance: true,
    ExpenditureStage: true,
    SimpleTargetProfile: true,
    SimpleTarget: true,
    NFT: true,
    NFTProfile: true,
    FunctionParam: true,
    ...
    ModelNotificationsDataConnection: true,
    ModelLiquidationAddressConnection: true,
    ModelColonyMultiSigFilterInput: true,
    SearchableColonyContributorConnection: true,
    SearchableColonyActionConnection: true,
    SearchableAggregateResult: true,
    SearchableAggregateGenericResult: true,
    SearchableAggregateScalarResult: true,
    SearchableAggregateBucketResult: true,
    SearchableAggregateBucketResultItem: true,
  ...
  // ============================================================
  paths: {
    'getUserByAddress.items.bridgeCustomerId': isOwnUser(),
    'getUserByAddress.items.notificationsData': isOwnUser(),
    'getUserByAddress.items.privateBetaInviteCode': isOwnUser(),
    'getUserByAddress.items.profile': isOwnUser(),
    'getUserByAddress.items.profile.meta': isOwnUser(),
  },
};
